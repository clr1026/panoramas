...
defs.h:
This file contains the headers for a sample program to read images and keypoints, 
then perform simple keypoint matching.
...
/* These are prototypes for the external functions that are shared between files.
*/
